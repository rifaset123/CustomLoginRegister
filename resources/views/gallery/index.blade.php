...
@section('content')
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Gallery - My Game of Decade</div>
                            ...
                            @foreach ($galleries as $gallery)
                                <div class="col-sm-4">
                                    <div>
                                        ...
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('gallery.destroy', $gallery['id']) }}" method="POST"  enctype="multipart/form-data">
                                            <a href="{{ route('gallery.edit', $gallery['id'])}}"  class="btn btn-outline-primary mt-2 ms-4 mb-2">Edit</a>
                                            @csrf
                                            @method('DELETE')
